      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: AnimatedBuilder(
            ...
            builder: (context, _) {
              // Two tabs only. The wallet now lives inside the Invest tab, and
              // an investor's portfolio sits on its own screen behind the
              // briefcase action in the top bar.
              final tabs = <({String label, Widget view})>[
                (label: 'Invest', view: const _InvestTab()),
